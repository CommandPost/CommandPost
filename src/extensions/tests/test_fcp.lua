...
local TEST_LIBRARY = "/tests/fcp/Test Library.fcpbundle"

local function loadLibrary()
	local testLibrary = config.scriptPath .. TEST_LIBRARY
	local output, status = os.execute("open '".. testLibrary .. "'")
	ok(status, output)
end
