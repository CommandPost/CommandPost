...
--- cp.finalcutpro.axutils.childWith(axuielement, string, anything) -> axuielement
--- Function
...
--- cp.finalcutpro.axutils.childWith(element, matcherFn) -> axuielement
--- Function
...
--- cp.finalcutpro.axutils.childrenWith(element, string, value) -> axuielement
--- Function
...
--- cp.finalcutpro.axutils.childrenMatching(axuielement, function) -> {axuielement}
--- Function
...
--- cp.finalcutpro.axutils.isValid(element, matcherFn) -> boolean
--- Function
...
--- cp.finalcutpro.axutils.isValid(axuielement) -> boolean
--- Function
--- Checks if the axuilelement is still valid
---
--- Parameters:
...
--- cp.finalcutpro.axutils.cached(table, string, function) -> axuielement
--- Function
