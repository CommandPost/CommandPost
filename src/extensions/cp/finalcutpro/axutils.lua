...
--- cp.finalcutpro.axutil.childWith(axuielement, string, anything) -> axuielement
--- Function:
...
--- cp.finalcutpro.axutil.childrenWith(axuielement, string, anything) -> axuielement
--- Function:
...
--- cp.finalcutpro.axutil.cached(table, string, function) -> axuielement
--- Function:
