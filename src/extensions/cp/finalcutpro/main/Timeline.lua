...
local TimelineContent					= require("cp.finalcutpro.main.TimelineContents")
local TimelineToolbar					= require("cp.finalcutpro.main.TimelineToolbar")
