...
--- === cp.finalcutpro.main.TimelineContents ===
---
...
--- cp.finalcutpro.main.TimelineContents:clipsUI(expandedGroups, filterFn) -> table of axuielements
--- Function
...
--- cp.finalcutpro.main.TimelineContents:playheadClipsUI(expandedGroups, filterFn) -> table of axuielements
--- Function
