...
function mod.defaultSearchConsoleToolbar()
    ...
    return {
        ...
        global_loupedeck_banks      = { path = iconPath .. "loupedeckbank.png",     priority = 53},
        global_loupedeckbanks       = { path = iconPath .. "loupedeckplusbank.png", priority = 54},
        global_loupedeckct_banks    = { path = iconPath .. "loupedeckctbank.png",   priority = 55},
        global_midibanks            = { path = iconPath .. "midibank.png",          priority = 56},
        global_streamDeckbanks      = { path = iconPath .. "streamdeckbank.png",    priority = 57},
        global_touchbarbanks        = { path = iconPath .. "touchbarbank.png",      priority = 58},
    }
end
