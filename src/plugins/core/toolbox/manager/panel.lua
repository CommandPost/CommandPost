...
--- plugins.core.utilities.manager.panel.new(params, manager) -> cp.core.utilities.manager.panel
--- Constructor
...
--- plugins.core.utilities.manager.panel:addSelect(priority, params) -> panel
--- Method
