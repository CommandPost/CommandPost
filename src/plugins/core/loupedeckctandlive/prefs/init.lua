...
local SNIPPET_HELP_URL = "https://commandpost.fcp.cafe/scripting/snippets-for-icons/"

-- SNIPPET_LED_HELP_URL -> string
-- Constant
-- URL to Snippet Support Site
local SNIPPET_LED_HELP_URL = "https://commandpost.fcp.cafe/scripting/snippets-for-led-colors/"
