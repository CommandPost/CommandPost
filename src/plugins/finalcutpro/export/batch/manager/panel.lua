...
--- plugins.finalcutpro.export.batch.manager.panel:getToolbarItem() -> table
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addContent(priority, content[, escaped]) -> panel
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addHandler(event, id, handlerFn, keys) -> none
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addParagraph(content[, escaped[, class]]) -> panel
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addHeading(text) -> panel
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addTextbox(params) -> panel
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addPassword(params) -> panel
--- Method
...
--- plugins.finalcutpro.export.batch.manager.panel:addButton(params) -> panel
--- Method
