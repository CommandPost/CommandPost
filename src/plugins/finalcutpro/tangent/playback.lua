...
function mod.init(fcpGroup)
    ...
    mod.group:action(baseID+1, i18n("play") .. "/" .. i18n("pause"))
        :onPress(function()
            fcp:doSelectMenu({"View", "Playback", "Play"})
        end)

    mod.group:action(baseID+2, i18n("playSelection"))
        :onPress(function()
            fcp:doSelectMenu({"View", "Playback", "Play Selection"})
        end)

    mod.group:action(baseID+3, i18n("playAround"))
        :onPress(function()
            fcp:doSelectMenu({"View", "Playback", "Play Around"})
        end)

    mod.group:action(baseID+4, i18n("playFromBeginning"))
        :onPress(function()
            fcp:doSelectMenu({"View", "Playback", "Play from Beginning"})
        end)
