...
--- hs.finalcutpro.characterStringToKeyCode() -> string
--- Function
...
--- hs.finalcutpro.keypadCharacterToKeyCode() -> string
--- Function
...
--- hs.finalcutpro.fcpxModifiersToHsModifiers() -> table
--- Function
...
--- hs.finalcutpro.modifierMaskToModifiers() -> table
--- Function
--- Translate Keyboard Modifiers from Command Set Format into Hammerspoon Format
---
--- Parameters:
